...
bwa mem -t 12 Reference_genome/Fv5_mainGenome_chr15Z.fasta mergedTagCounts/mergedTagCounts.fq > topm/Fv5_mainGenome_chr15Z.sam
...
perl ./filter_bwa_mem.pl topm/Fv5_mainGenome_chr15Z.sam topm/Fv5_mainGenome_chr15Z.filt.sam 1

# SAMConverterPlugin - BWA
~/programs/tassel3-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -SAMConverterPlugin -i topm/Fv5_mainGenome_chr15Z.filt.sam -o topm/Fv5_mainGenome_chr15Z.topm -endPlugin -runfork1 > topm/topm_Z.log 2> topm/topm.err
...
~/programs/tassel3-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -tbt2vcfPlugin -i mergedTBT/mergedTBT.tbt.byte -m topm/Fv5_mainGenome_chr15Z.topm -o tbt2vcf -mnMAF 0.05 -mnLCov 0.0 -ak 4 -s 1 -e 844 -endPlugin -runfork1 > tbt2vcf15Z/tbt2vcf15Z.log 2> tbt2vcf15Z/tbt2vcf15Z.err
...
~/programs/vcftools_0.1.13/bin/vcf-concat tbt2vcf15Z/mergedTBT.c*.gz | gzip -c > hyden_vcf/Fv5_mainGenome_chr15Z.ape.vcf.gz

# De-compress VCF to merge and sort
gunzip -cd hyden_vcf/Fv5_mainGenome_chr15Z.ape.vcf.gz > hyden_vcf/Fv5_mainGenome_chr15Z.ape.vcf

# Merge duplicate SNPs
~/programs/tassel3-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -MergeDuplicateSNP_vcf_Plugin -i hyden_vcf/Fv5_mainGenome_chr15Z.ape.vcf -ak 4 -o hyden_vcf/Fv5_mainGenome_chr15Z.ape.MergedDup.vcf -endPlugin -runfork1

# Sort the VCF
~/programs/tassel-5-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -SortGenotypeFilePlugin -inputFile hyden_vcf/Fv5_mainGenome_chr15Z.ape.mergedDup.vcf -outputFile hyden_vcf/Fv5_mainGenome_chr15Z.ape.MergedDupSorted.vcf -fileType VCF -endPlugin -runfork1

# Compress and index sorted VCF
bgzip hyden_vcf/Fv5_mainGenome_chr15Z.ape.MergedDupSorted.vcf
tabix -p vcf hyden_vcf/Fv5_mainGenome_chr15Z.ape.MergedDupSorted.vcf.gz
...
#bgzip vcf/Fv5_mainGenome_chr15Z.family317.filt.vcf
#tabix -p vcf vcf/Fv5_mainGenome_chr15Z.mG.family317.filt.vcf.gz
...
#~/programs/tassel3-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -tbt2vcfPlugin -i mergedTBT/mergedTBT.tbt.byte -m topm/Fv5_mainGenome_chr15Z.topm -o tbtx2vcf -mnMAF 0.05 -mnLCov 0.0 -ak 4 -s 1 -e 844 -endPlugin -runfork1 > tbtx2vcf/tbtx2vcf.log 2> tbtx2vcf/tbtx2vcf.err
...
# Concatenate VCFs and gzip the output
#~/programs/vcftools_0.1.13/bin/vcf-concat tbtx2vcf/mergedTBT.c*.gz | gzip -c > vcf_mergedTaxa/Fv5_mainGenome_chr15Z.vcf.gz

# De-compress VCF to merge and sort
#gunzip -cd vcf_mergedTaxa/Fv5_mainGenome_chr15Z.vcf.gz > vcf_mergedTaxa/Fv5_mainGenome_chr15Z.vcf

# Merge duplicate SNPs
#~/programs/tassel3-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -MergeDuplicateSNP_vcf_Plugin -i vcf_mergedTaxa/Fv5_mainGenome_chr15Z.vcf -ak 4 -o vcf_mergedTaxa/Fv5_mainGenome_chr15Z.mergedDup.vcf -endPlugin -runfork1

# Sort the VCF
#~/programs/tassel-5-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -SortGenotypeFilePlugin -inputFile vcf_mergedTaxa/Fv5_mainGenome_chr15Z.mergedDup.vcf -outputFile vcf_mergedTaxa/AFv5_mainGenome_chr15Z.mergedDupSorted.vcf -fileType VCF -endPlugin -runfork1

# Compress and index sorted VCF
#bgzip vcf_mergedTaxa/Fv5_mainGenome_chr15Z.mergedDupSorted.vcf
#tabix -p vcf vcf_mergedTaxa/Fv5_mainGenome_chr15Z.mergedDupSorted.vcf.gz
