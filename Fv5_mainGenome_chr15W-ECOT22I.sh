...
cd "/Volumes/HAL9000/genomics/salix_ngs_fastq/fastq_gbs/Hyden/F2_EcoT22I"
...
bwa mem -t 12 Reference_genome/Fv5_mainGenome_chr15W.fasta mergedTagCounts/mergedTagCounts.fq > topm/Fv5_mainGenome_chr15W.eco.sam
...
perl ./filter_bwa_mem.pl topm/Fv5_mainGenome_chr15W.eco.sam topm/Fv5_mainGenome_chr15W.eco.filt.sam 1

# SAMConverterPlugin - BWA
~/programs/tassel3-standalone/run_pipeline.pl -Xms2g -Xmx56g -fork1 -SAMConverterPlugin -i topm/Fv5_mainGenome_chr15W.eco.filt.sam -o topm/Fv5_mainGenome_chr15W.eco.topm -endPlugin -runfork1 > topm/topm_15W.log 2> topm/topm_15W.err
...
~/programs/tassel3-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -tbt2vcfPlugin -i mergedTBT/mergedTBT.tbt.byte -m topm/Fv5_mainGenome_chr15W.eco.topm -o tbt2vcf -mnMAF 0.05 -mnLCov 0.0 -ak 4 -s 1 -e 844 -endPlugin -runfork1 > tbt2vcf/tbt2vcf.log 2> tbt2vcf/tbt2vcf.err
...
~/programs/vcftools_0.1.13/bin/vcf-concat tbt2vcf/mergedTBT.c*.gz | gzip -c > hyden_vcf/Fv5_mainGenome_chr15W.eco.vcf.gz

# De-compress VCF to merge and sort
gunzip -cd hyden_vcf/Fv5_mainGenome_chr15W.eco.vcf.gz > hyden_vcf/Fv5_mainGenome_chr15W.eco.vcf

# Merge duplicate SNPs
~/programs/tassel3-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -MergeDuplicateSNP_vcf_Plugin -i hyden_vcf/Fv5_mainGenome_chr15W.eco.vcf -ak 4 -o hyden_vcf/Fv5_mainGenome_chr15W.eco.mergedDup.vcf -endPlugin -runfork1

# Sort the VCF
~/programs/tassel-5-standalone/run_pipeline.pl -Xms4g -Xmx56g -fork1 -SortGenotypeFilePlugin -inputFile hyden_vcf/Fv5_mainGenome_chr15W.eco.mergedDup.vcf -outputFile hyden_vcf/Fv5_mainGenome_chr15W.eco.mergedDupSorted.vcf -fileType VCF -endPlugin -runfork1

# Compress and index sorted VCF
bgzip hyden_vcf/Fv5_mainGenome_chr15W.eco.MergedDupSorted.vcf
tabix -p vcf hyden_vcf/Fv5_mainGenome_chr15W.eco.MergedDupSorted.vcf.gz
